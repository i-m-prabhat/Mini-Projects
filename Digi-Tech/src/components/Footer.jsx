...
const Footer = () =>
{
    return (<div className='bg-[#4a62ff]'>
        <div className='max-w-[1240px] bg-[#4a62ff] mx-auto py-16 px-4 grid lg:grid-cols-3 gap-8 text-white'>
            <div>
                <h1 className='w-full text-3xl font-bold text-black'>DiGi Tech.</h1>
